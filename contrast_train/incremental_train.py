# Load model, incremental training, save the model
import sys
import numpy as np
...
def main(args, dataset):
    ...
    torch.save(model.state_dict(), './model/embedding_incred.pth')


if __name__ == '__main__':
    _,_,_,label_acc_dict,label_eff_dict = preprocess()
    f_feature = open('../data/feature/feature_dicts_inred.dict','rb')
    f_A = open('../data/feature/A_mat_inred.dict','rb')
    f_W = open('../data/feature/W_mat_inred.dict','rb')
